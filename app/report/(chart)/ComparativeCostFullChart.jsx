...
const data = [
  ...
  { value: 55, label: "2024-05", frontColor: "#003366" },
];

const ComparativeCostFullChart = () => {
  ...
  const handleBarPress = (item, index) => {
    setTooltip({
      ...
      y: height - (item.value / 250) * (height - 300) - 150, // Approximate y position
      type: item.type,
    });
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.mainTitle}>REPORT {'>'} COMPARATIVE {'>'} COST CONSUMPTION</Text>
      ...
      <ScrollView contentContainerStyle={styles.chartContainer}>
        <View style={styles.chartBox}>
          <BarChart
            ...
            yAxisLabel="($) "
            noOfSections={5}
            maxValue={250} // Adjusted for total cost
            yAxisThickness={0}
            xAxisColor="#000"
...
export default ComparativeCostFullChart;
