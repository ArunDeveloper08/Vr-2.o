...
// // Dummy cost data (₹)
// const rawCostData = [
//   { value: 50, label: '2025-05-01' },
//   { value: 120, label: '2025-05-02' },
//   { value: 80, label: '2025-05-03' },
//   { value: 100, label: '2025-05-04' },
//   { value: 30, label: '2025-05-05' },
//   { value: 60, label: '2025-05-06' },
// ];

// // Format date to "01 May 2025"
// const costChartData = rawCostData.map(item => {
...
//           </TouchableOpacity>
//           <Text style={styles.title}>GRID/DG COST (₹)</Text>
//           <View style={{ width: 24 }} />
//         </View>
...
const router = useRouter();
  ...
  // const formattedData1 = parsedData1.map((item) => ({
  //   ...item,
  //   label: formatDateLabel(item.label),
  // }));

  // const formattedData2 = parsedData2.map((item) => ({
  //   ...item,
  //   label: formatDateLabel(item.label),
  // }));

const maxValue =
    Math.max(...parsedData1.map((d) => d.value), ...parsedData2.map((d) => d.value)) + 20;
